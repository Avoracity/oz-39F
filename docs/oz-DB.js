var ozArray = [
    {"question": " What is the name of the broker residing in Magatia? " , "answer": " Han the Broker " },{"question": " What is the name of the buddy list admin in Lith Harbor? " , "answer": " Mr. Goldstein " },{"question": " What is the name of the buddy list admin in Ludibrium? " , "answer": " Robert Holly " },{"question": " What is the name of the dog sitting next to the Dimensional Mirror in Orbis? " , "answer": " Moppie " },
    {"question": " What is the name of the current council president in Edelstein? " , "answer": " Anthony " },{"question": " What is the name of the former council president in Edelstein? " , "answer": " Albert " },{"question": " What is the name of the grandma guarding the Great Temple in Pantheon? " , "answer": " Selene " },{"question": " What is the name of the helmsman of Riena Strait Glacial Observatory? " , "answer": " Helmsman Tanya " },{"question": " What is the name of the Humanoid residing in Magatia? " , "answer": " Humanoid A " },
    {"question": " What is the name of the kid monk in front of the Golden Temple entrance? " , "answer": " Noi " },{"question": " What is the name of the merchant on the Nautilus? " , "answer": " Gali " },
    ...
    {"question": " What is the name of the skin care expert in Ariant? " , "answer": " Lila " },{"question": " What is the name of the storage keeper in Ludibrium? " , "answer": " Seppy " },
    ...
    {"question": " What is the name of the warp helper in Herb Town? " , "answer": " Crane " },{"question": " What is the name of the weapon merchant in Ariant? " , "answer": " Zaid " },
    {"question": " What is the name of the weapon seller on the Nautilus? " , "answer": " Morgan " },{"question": " Who in Kerning City can repair items? " , "answer": " JM From tha Streetz " },{"question": " Who is the item creator in front of the Sleepywood Hotel? " , "answer": " Chrishrama " },
